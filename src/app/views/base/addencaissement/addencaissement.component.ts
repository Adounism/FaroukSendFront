...
@Component({
  selector: 'app-addencaissement',
  templateUrl: './addencaissement.component.html',
  styleUrls: ['./addencaissement.component.scss']
})
export class AddencaissementComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.transactionForm =  this.fb.group({
      ...
      collectionType:['collection', [Validators.nullValidator]],
    ...
    if(this.transactionForm.valid){
      ...
      if(this.transactionData.amount != "" && this.transactionData.amount > 0){
        ...
        this.transService.createtresorieOpe(transaction).then(resp=>{
          ...
          this.toast.success({
            detail:"Encaissement effectués avec succes",
            summary:"Encaissement",
            duration: 3000
            });
            this.router.navigate(['/base/encaissement']);
        ...
        this.toast.warning({
          ...
          summary:"Encaissement impossible montant invalid",
          duration: 3000
          });
      }
