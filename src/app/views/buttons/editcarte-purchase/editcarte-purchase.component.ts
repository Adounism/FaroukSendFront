...
import { CardService } from 'src/app/services/card.service';@Component({
  selector: 'app-editcarte-purchase',
  templateUrl: './editcarte-purchase.component.html',
  styleUrls: ['./editcarte-purchase.component.scss']
})
export class EditcartePurchaseComponent implements OnInit {
  ...
  ajouter(form:NgForm){
    ...
    if(form){
      ...
      if(this.transactionData.carte['id'] == undefined){
        ...
        this.toast.warning({
          detail:"Veiilez selectionner un type de carte",
          summary:"",
          duration: 3000
          });
      ...
      //       duration: 3000
      //       });
      //       this.router.navigate(['/buttons/transaction']);
